...
async function main() {
  ...
  console.log("object",contractObject,JSON.stringify(contractObject))
  
  fs.writeFile("./frontend/contracts/gameContracts.json",JSON.stringify(contractObject), function(err,content){
          if (err) throw err;
